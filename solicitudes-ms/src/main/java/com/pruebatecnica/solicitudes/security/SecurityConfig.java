package com.pruebatecnica.solicitudes.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        //.requestMatchers("/api/auth/**").permitAll()  // login/registro abiertos
                        //.requestMatchers("/api/solicitudes/**").authenticated() // solicitudes protegidas
